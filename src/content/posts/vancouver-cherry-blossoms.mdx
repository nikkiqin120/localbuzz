...
coverImage: "/images/posts/vancouver-cherry-blossoms/cover.jpg"
tags: ["vancouver", "cherry-blossoms", "spring", "photography", "local-guide"]
---


The cherry blossom trees across Metro Vancouver are in full swing! If you're looking for the best places to catch these beautiful cherry blossom trees this weekend, here's your ultimate sakura guide with local favorites, photo tips, and secret corners.
...
<div className="my-8 relative aspect-[16/9] w-full overflow-hidden rounded-lg shadow-lg">
  <div className="absolute inset-0 bg-gradient-to-br from-pink-100/20 to-purple-100/20 mix-blend-overlay"></div>
  <img
    src="/images/posts/vancouver-cherry-blossoms/queen-eliz.jpg"
    alt="Queen Elizabeth Park Cherry Blossoms"
